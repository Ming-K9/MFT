...
# Basic configuration
NUM_GPUS=8
BASE_MODEL=output/fft_7b_math
CONFIG_FILE=configs/train_configs/llama2_7b_math_local_masktune.yaml
...
run_experiment() {
    ...
    local EXP_ID="masktune_7b_local_${config_name}_0.9_math"
